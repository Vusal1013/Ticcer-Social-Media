  ...
  return (
    <LinearGradient colors={[colors.background, colors.surface]} style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <TouchableOpacity style={[styles.row, { borderBottomColor: colors.border }]} onPress={() => navigation.navigate('LanguageSelector')}>
          <Ionicons name="globe-outline" size={20} color={colors.text} style={{ marginRight: 12 }} />
          <Text style={[styles.rowText, { color: colors.text }]}>Dil</Text>
          <Text style={[styles.rowValue, { color: colors.textMuted }]}>{getLocaleLabel(locale)}</Text>
