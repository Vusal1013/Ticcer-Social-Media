        ...
        <View style={styles.headerInfo}>
          <View style={styles.nameRow}>
            ...
            {post.visibility === 'close_friends' && (
              <View style={[styles.closeFriendsBadge, { backgroundColor: colors.success + '20' }]}>
                <Ionicons name="people" size={10} color={colors.success} />
                <Text style={[styles.closeFriendsText, { color: colors.success }]}>Yaxın</Text>
              </View>
            )}
          </View>
...
const styles = StyleSheet.create({
  ...
  closeFriendsBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 8, marginLeft: 6 },
  closeFriendsText: { fontSize: 9, fontWeight: '700' },
